function createModel(nGPU)
   ...
   fb1:add(nn.SpatialBatchNormalization(96))

   fb1:add(cudnn.ReLU())
   fb1:add(nn.SpatialZeroPadding(1,0,1,0))
   fb1:add(cudnn.SpatialMaxPooling(3,3,2,2))                   -- 55 ->  27
   fb1:add(nn.Dropout(0.5))
   fb1:add(cudnn.SpatialConvolution(96,51,1,5,1,1,0,2))       --  27 -> 27
   fb1:add(cudnn.SpatialConvolution(51,192,5,1,1,1,2,0))       --  27 -> 27
   --fb1:add(nn.SpatialBatchNormalization(192))
   fb1:add(cudnn.ReLU())
   ...
   fb1:add(cudnn.ReLU())
   fb1:add(nn.SpatialZeroPadding(1,0,1,0))
   fb1:add(cudnn.SpatialAveragePooling(3,3,2,2))                   --  27 ->  13
   fb1:add(nn.Dropout(0.5))
   --fb1:add(cudnn.SpatialConvolution(192,192,3,3,1,1,1,1))      --  13 ->  13
   fb1:add(cudnn.SpatialConvolution(192,192,3,3,1,1,1,1))      --  13 ->  13
   fb1:add(nn.SpatialBatchNormalization(192))
   --fb1:add(cudnn.SpatialConvolution(192,64,1,3,1,1,0,1))      --  13 ->  13
   --fb1:add(cudnn.SpatialConvolution(64,192,3,1,1,1,1,0))      --  13 ->  13
   fb1:add(cudnn.ReLU())
