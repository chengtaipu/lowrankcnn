...
local baseline = nn.Sequential()
      baseline:add(cudnn.SpatialConvolution(3,96,5,5,1,1,2,2))
      baseline:add(cudnn.ReLU())
      baseline:add(cudnn.SpatialMaxPooling(2,2,2,2))
      baseline:add(cudnn.SpatialConvolution(96,128,5,5,1,1,2,2))
      baseline:add(cudnn.ReLU())
      baseline:add(cudnn.SpatialMaxPooling(2,2,2,2))
      baseline:add(cudnn.SpatialConvolution(128,256,5,5,1,1,2,2))
      baseline:add(cudnn.ReLU())
      baseline:add(cudnn.SpatialMaxPooling(2,2,2,2))
