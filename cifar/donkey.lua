...
local loadSize   = {3, 32, 32}
local sampleSize = {3, 32, 32}
...
local function loadImage(path)
   ...
   -- find the smaller dimension, and resize it to 32 (while keeping aspect ratio)
...
local trainHook = function(self, path)
 ...
 --     dx = torch.uniform(-2,2)
   --   dy = torch.uniform(-2,2)
   --   out = image.translate(out, dx, dy)
  -- end
